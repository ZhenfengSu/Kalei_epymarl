...
# ========== K-2:4 Agent for SMACv2 ==========
import sys
import os
# Add the layer directory to the path

paraten_dir = os.path.dirname(os.path.dirname(__file__))
sys.path.insert(0, os.path.join(paraten_dir, 'layer'))
from k24_pattern_gumbel_layer import SemiStructuredLinear24
from k24_diversity import LayerPatternTracker


class K24_type_NRNNAgent_1R3(nn.Module):
    """
    K-2:4 RNN Agent for SMACv2 environments.

    Creates heterogeneous strategies for different unit types using 2:4
