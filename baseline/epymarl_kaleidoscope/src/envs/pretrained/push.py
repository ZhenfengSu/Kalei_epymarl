...
class PretrainedPush_5v2(gym.Wrapper):
    """Push with pretrained agent"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.prey1 = DDPG(29, 5, 50, 128, 0.01)
        self.prey2 = DDPG(29, 5, 50, 128, 0.01)

        param_path = os.path.join(
            os.path.dirname(__file__), "simple_push_5v2_maddpg.pt"
        )
